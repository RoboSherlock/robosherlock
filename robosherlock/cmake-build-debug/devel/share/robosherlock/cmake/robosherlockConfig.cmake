...
if(robosherlock_CONFIG_INCLUDED)
  return()
endif()
set(robosherlock_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(robosherlock_SOURCE_PREFIX /home/hassouna/perception/rs_ws/src/robosherlock/robosherlock)
  set(robosherlock_DEVEL_PREFIX /home/hassouna/perception/rs_ws/src/robosherlock/robosherlock/cmake-build-debug/devel)
  set(robosherlock_INSTALL_PREFIX "")
  set(robosherlock_PREFIX ${robosherlock_DEVEL_PREFIX})
else()
  set(robosherlock_SOURCE_PREFIX "")
  set(robosherlock_DEVEL_PREFIX "")
  set(robosherlock_INSTALL_PREFIX /usr/local)
  set(robosherlock_PREFIX ${robosherlock_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'robosherlock' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND robosherlock_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hassouna/perception/rs_ws/src/robosherlock/robosherlock/cmake-build-debug/devel/lib;/home/hassouna/perception/rs_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(robosherlock_LIBRARY_DIRS ${lib_path})
      list(APPEND robosherlock_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'robosherlock'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND robosherlock_LIBRARIES ${lib})
    endif()
  endif()
...
set(robosherlock_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${robosherlock_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "pcl_ros;cv_bridge;robosherlock_msgs;uimacpp_ros;rapidjson_ros")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 robosherlock_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${robosherlock_dep}_FOUND)
      find_package(${robosherlock_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robosherlock_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(robosherlock_INCLUDE_DIRS ${${robosherlock_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(robosherlock_LIBRARIES ${robosherlock_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${robosherlock_dep}_LIBRARIES})
  _list_append_deduplicate(robosherlock_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(robosherlock_LIBRARIES ${robosherlock_LIBRARIES})

  _list_append_unique(robosherlock_LIBRARY_DIRS ${${robosherlock_dep}_LIBRARY_DIRS})
  list(APPEND robosherlock_EXPORTED_TARGETS ${${robosherlock_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "/home/hassouna/perception/rs_ws/src/robosherlock/robosherlock/cmake/robosherlock.cmake;robosherlock_config.cmake;/home/hassouna/perception/rs_ws/src/robosherlock/robosherlock/cmake/project_config.cmake.in")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${robosherlock_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
