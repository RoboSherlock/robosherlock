...
#define OUT_AUX_INT(FILE_COLOR, MSG_COLOR, LEVEL, STREAM, MSG, FILE, LINE, FUNCTION) STREAM << FILE_COLOR << FILE << NO_COLOR "(" FG_CYAN << LINE << NO_COLOR ")[" FG_YELLOW << FUNCTION << NO_COLOR "] " MSG_COLOR << MSG << NO_COLOR << std::endl << std::flush
