...
#ifndef __ROS_REALSENSE_BRIDGE_H__
#define __ROS_REALSENSE_BRIDGE_H__
...
class ROSRealSenseBridge : public ROSCamInterface
{
private:
...
public:
  ROSRealSenseBridge(const boost::property_tree::ptree &pt);
  ~ROSRealSenseBridge();
...
#endif // __ROS_REALSENSE_BRIDGE_H__
