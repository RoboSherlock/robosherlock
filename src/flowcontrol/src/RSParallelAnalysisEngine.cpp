...
RSParallelAnalysisEngine::RSParallelAnalysisEngine(AnnotatorContext &rANC,
                                                   bool bOwnsANC,
...
uima::AnalysisEngine* rs::createParallelAnalysisEngine(icu::UnicodeString const &aeFile
...
uima::AnalysisEngine* rs::createParallelAnalysisEngine(uima::AnnotatorContext &rANC,
