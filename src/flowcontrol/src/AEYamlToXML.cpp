...
void AEYamlToXMLConverter::getOutput(ofstream& out) {
    ...
    out << "  <primitive>false</primitive>" << endl;
   ...
   // out << "    <typeSystemDescription>" << endl;
   // out << "      <imports>" << endl;
   // out << "        <import location=" << "\"" << typePath << "\"/>" << endl;
   // out << "      </imports>" << endl;
   // out << "    </typeSystemDescription>\n" << endl;
    out << "    <operationalProperties>" << endl;
    out << "      <modifiesCas>true</modifiesCas>" << endl;
    out << "      <multipleDeploymentAllowed>true</multipleDeploymentAllowed>" << endl;
    out << "      <outputsNewCASes>false</outputsNewCASes>" << endl;
